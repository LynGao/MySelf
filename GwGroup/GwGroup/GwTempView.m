...
//        UILabel *tempLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
//        [tempLabel setText:[NSString stringWithFormat:@"%d",_temp]];
//        [tempLabel setBackgroundColor:[UIColor clearColor]];
//        [tempLabel setTextColor:[UIColor whiteColor]];
//        [tempLabel setTextAlignment:NSTextAlignmentCenter];
//        [tempLabel setFont:[UIFont systemFontOfSize:80]];
//        
...
//        [zero setFont:[UIFont systemFontOfSize:20]];
//        
...
{
    [super drawRect:rect];
    NSString *targ = [NSString stringWithFormat:@"%do",_temp];
    ...
    [attrbu addAttribute:(NSString *)kCTFontAttributeName value:(id)CFBridgingRelease(CTFontCreateWithName((CFStringRef)[UIFont fontWithName:@"Times New Roman" size:80].fontName, 80, NULL)) range:NSMakeRange(0, targ.length-1)];
